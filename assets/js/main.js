...
let budgetController = (function () {
    ...
    let Expense = function (id, description, value, date, percentage) {
        this.id = id;
...
let UIController = (function () {
    ...
    let displayDate = function (enteredDate) {
...
let controller = (function (budgetCtrl, UICtrl) {
    ...
    let ctrlAddItem = function () {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            let newItem = budgetCtrl.addItem(input.type, input.description, input.value, new Date(input.date));
